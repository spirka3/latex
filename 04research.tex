...
% Ostatné parametre pre tréning majú hodnoty prednastavené podľa všeobecného odporúčania pre prvý tréning.
...
TODO, opísať tréning a jeho zlepšovanie. Pri trénovaní sme mali k dispozícii informácie o priebežných výsledkoch. Po každej vykonenej epoche sa vypísal výsledok z testovania na validačnej sade. Pokiaľ sa vývoj nezlepšoval, mohli sme tréning v hociktorom momente zastaviť. Z najlepších výsledkov sa ukončili váhy na disk. Vývoj presnosti a citlivosti na validačnej sade je zobrazený na obrázku \ref{img:lab}. Vývoj mAP50 a mAP50-95 je zobrazený na obrázku \ref{img:lab}.

TODO, ešte raz toľko textu opísať tréning a jeho zlepšovanie. Pri trénovaní sme mali k dispozícii informácie
o priebežných výsledkoch. Po každej vykonenej epoche sa vypísal výsledok z testova-
nia na validačnej sade. Pokiaľ sa vývoj nezlepšoval, mohli sme tréning v hociktorom
momente zastaviť. Z najlepších výsledkov sa ukončili váhy na disk. Vývoj presnosti a
citlivosti na validačnej sade je zobrazený na obrázku 5.1. Vývoj mAP50 a mAP50-95
je zobrazený na obrázku...
\\
\begin{figure}[ht]
    \centering
...
% todo pridat vyššie nejaký text, aby bol obrázok na novej strane - zrejme k trackovaniu
\newpage
\begin{figure}[ht]
     \centering
