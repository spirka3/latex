...
%HOTA is calculated at a number of different localisation thresholds α, and the final HOTA score is the average of the HOTAα scores calculated at each threshold. This formulation ensures that the final HOTA score takes the actual localisation accuracy into account.

Lokalizácia (Loc) meria priestorové zarovnanie medzi predikovanou detekciou a skutočnou hodnotou. Vypočíta sa ako pomer ich prieniku a zjednotenia. Keď sa Loc skóre zvýši, predikované a skutočné detekcie sú priestorovo lepšie zarovnané a lokalizácia je zlepšía.
\\
\begin{figure}[ht]
    \centering
